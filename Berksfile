...
cookbook 'elasticsearch', git: 'git://github.com/elasticsearch/cookbook-elasticsearch.git', tag: 'v1.0.3'
cookbook 'mongodb', git: 'git://github.com/edelight/chef-mongodb'
cookbook 'kibana', git: 'https://github.com/deavus/chef-kibana.git'
